package com.mipresupuesto.personalbudget.crosscuting.exception.general;
...
public class GeneralException extends RuntimeException {
	...
	private void setTechnicalMessage(String technicalMessage) {
		this.technicalMessage = UtilText.trim(technicalMessage);
	}
	private void setRootException(Exception rootException) {
		this.rootException = UtilObject.getUtilObject().getDefault(rootException,
				new Exception());
	}
